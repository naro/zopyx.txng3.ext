...
static int r_palatalise(struct SN_env * z) {
    ...
    z->bra = z->c; /* ], line 60 */
    {   int ret = r_RV(z);
        if (ret == 0) return 0; /* call RV, line 60 */
        if (ret < 0) return ret;
    }
    switch(among_var) {
        case 0: return 0;
...
static int r_do_possessive(struct SN_env * z) {
    ...
    among_var = find_among_b(z, a_1, 3); /* substring, line 73 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 73 */
    {   int ret = r_RV(z);
        if (ret == 0) return 0; /* call RV, line 73 */
        if (ret < 0) return ret;
    }
    switch(among_var) {
        case 0: return 0;
        ...
        case 2:
            ...
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 79 */
                {   int ret = r_palatalise(z);
                    if (ret == 0) { z->c = z->l - m_keep; goto lab0; } /* call palatalise, line 79 */
                    if (ret < 0) return ret;
                }
            lab0:
                ;
    ...
    switch(among_var) {
        ...
        case 2:
            ...
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 100 */
                {   int ret = r_palatalise(z);
                    if (ret == 0) { z->c = z->l - m_keep; goto lab0; } /* call palatalise, line 100 */
                    if (ret < 0) return ret;
                }
            lab0:
                ;
        ...
        case 3:
            ...
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 105 */
                {   int ret = r_palatalise(z);
                    if (ret == 0) { z->c = z->l - m_keep; goto lab1; } /* call palatalise, line 105 */
                    if (ret < 0) return ret;
                }
            lab1:
                ;
...
static int r_do_derivational(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 2:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 127 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 132 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 137 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 142 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 148 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_do_augmentative(struct SN_env * z) {
    ...
    among_var = find_among_b(z, a_5, 4); /* substring, line 161 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 161 */
    switch(among_var) {
        case 0: return 0;
        ...
        case 2:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 167 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_do_diminutive(struct SN_env * z) {
    ...
    among_var = find_among_b(z, a_6, 42); /* substring, line 173 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 173 */
    switch(among_var) {
        case 0: return 0;
        ...
        case 2:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 184 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 189 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 194 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 199 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
...
static int r_do_comparative(struct SN_env * z) {
    ...
    among_var = find_among_b(z, a_7, 2); /* substring, line 213 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 213 */
    switch(among_var) {
        case 0: return 0;
        case 1:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 217 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            ...
            {   int ret = r_palatalise(z);
                if (ret == 0) return 0; /* call palatalise, line 222 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_do_aggressive(struct SN_env * z) {
    {   int m1 = z->l - z->c; (void)m1; /* do, line 228 */
        {   int ret = r_do_comparative(z);
            if (ret == 0) goto lab0; /* call do_comparative, line 228 */
            if (ret < 0) return ret;
        }
    lab0:
        z->c = z->l - m1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* do, line 229 */
        {   int ret = r_do_diminutive(z);
            if (ret == 0) goto lab1; /* call do_diminutive, line 229 */
            if (ret < 0) return ret;
        }
    lab1:
        z->c = z->l - m2;
    ...
    {   int m3 = z->l - z->c; (void)m3; /* do, line 230 */
        {   int ret = r_do_augmentative(z);
            if (ret == 0) goto lab2; /* call do_augmentative, line 230 */
            if (ret < 0) return ret;
        }
    lab2:
        z->c = z->l - m3;
    ...
    {   int m4 = z->l - z->c; (void)m4; /* or, line 231 */
        {   int ret = r_do_derivational(z);
            if (ret == 0) goto lab4; /* call do_derivational, line 231 */
            if (ret < 0) return ret;
        }
        goto lab3;
    lab4:
        ...
        {   int ret = r_do_deriv_single(z);
            if (ret == 0) return 0; /* call do_deriv_single, line 231 */
            if (ret < 0) return ret;
        }
    }
lab3:
...
extern int czech_UTF_8_stem(struct SN_env * z) {
    {   int c1 = z->c; /* do, line 236 */
        {   int ret = r_mark_regions(z);
            if (ret == 0) goto lab0; /* call mark_regions, line 236 */
            if (ret < 0) return ret;
        }
    lab0:
        z->c = c1;
    ...
    {   int ret = r_do_case(z);
        if (ret == 0) return 0; /* call do_case, line 238 */
        if (ret < 0) return ret;
    }
    {   int ret = r_do_possessive(z);
        if (ret == 0) return 0; /* call do_possessive, line 239 */
        if (ret < 0) return ret;
    }
    {   int ret = r_do_aggressive(z);
        if (ret == 0) return 0; /* call do_aggressive, line 242 */
        if (ret < 0) return ret;
    }
    z->c = z->lb;
    return 1;
